...
public class HelpDeskHelper extends JFrame{
	...
	public HelpDeskHelper(){
		...
		descriptionTA = new JTextArea(100,1);
		descriptionTA.setPreferredSize(new Dimension(600, 400));
		...
		descriptionP.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
	...
	public class BHandler implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			try {
				...
				writer.println("");
				writer.println("INFO: " + descriptionTA.getText() );
				writer.close();
